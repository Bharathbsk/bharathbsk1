...
class Result1{
	...
	public Result1(String out1, String out2, String out3) {
		super();
		output1 = out1;
		output2 = out2;
		output3 = out3;
...
public class EncodeingThreeeString1 {
   public static void main(String[] args) {
	EncodeingThreeeString1 m=new EncodeingThreeeString1();
	Scanner sc=new Scanner(System.in);
    String a=sc.next();
    String b=sc.next();
    String c=sc.next();
	Result1 r=m.encodingThreeStrings(a,b,c);
	System.out.println();
}

public Result1 encodingThreeStrings(String input1, String input2, String input3) {
	...
	String frnt1="",mid1="",end1="";
	  ...
	  output1=frnt1+end3+mid3;
	  output2=mid2+frnt1+end3;
	  output3=end1+mid2+frnt3;
	  output3=changeCase(output3);
	  System.out.println(output1);
	  System.out.println(output2);
	  System.out.println(output3);
	  Result1 rs=new Result1(output1,output2,output3);
	  return rs;
	    }
